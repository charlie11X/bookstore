  ...
  return (
    <div className="cart">
      <div className="cart-heading">
        <h1 className="cart-heading-h">Cart Page</h1> <hr />
      </div>

      <div className="cart-shopping">
        <h2>My Cart ({itemsInCart} items)</h2>
          ...
          return (
            <div className="cart-product" key={cartItem.id}>
              ...
              <div className="cart-product-middle">
                <div className="cart-product-name">{cartItem.book.name}</div>
